    ...
    <nav className="bg-base-200 border-b border-base-300 sticky top-0 z-30 h-16 flex items-center">
        <div className="w-full px-2 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-2">
            <button onClick={onMenuClick} className="btn btn-ghost btn-circle lg:hidden" aria-label="Open navigation menu">
           ...
           <div className="flex items-center gap-1 sm:gap-4">
            <Link to="/create-post" className="btn btn-primary btn-sm gap-1.5 rounded-full px-3 sm:px-4">
              <Plus className="size-5" /><span className="hidden sm:inline">Create</span>
            </Link>
