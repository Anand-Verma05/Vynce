  ...
  return (
    <div className="min-h-full w-full bg-base-200/40 px-4 py-6 sm:px-8">
      <div className="mx-auto w-full max-w-6xl space-y-5">
        <div>
          <p className="text-sm font-semibold text-primary">YOUR COMMUNITY</p>
          <h1 className="text-3xl font-black tracking-tight">
            A place to connect.
          </h1>
          <p className="mt-1 text-sm opacity-65">
            Share moments, ideas, and conversations with your people.
          </p>
        </div>
          ...
          <div className="card-body p-4">
            <div className="flex gap-3">
              ...
              <textarea
                ...
                className="textarea textarea-bordered min-h-20 flex-1 resize-none"
              />
            </div>
        ...
        {isLoading ? (
          ...
          <div className="card bg-base-100 p-10 text-center">
            ...
            <h2 className="text-xl font-bold">Your feed is waiting</h2>
            <p className="mt-1 opacity-65">
              Add friends to start seeing their posts here.
            </p>
          </div>
        )}
      </div>
