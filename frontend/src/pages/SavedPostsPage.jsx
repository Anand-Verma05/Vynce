        ...
        <div className="mb-7 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 opacity-65">
              Your collection of posts worth coming back to.
            </p>
          </div>
        </div>
        {isLoading ? (
          ...
          <div className="card mx-auto max-w-xl border border-base-300 bg-base-100 p-10 text-center shadow-sm">
            <Bookmark className="mx-auto mb-3 text-primary" size={36} />
            <h2 className="text-xl font-bold">Nothing saved yet</h2>
            <p className="mt-1 opacity-65">
              Tap the bookmark icon on a post to keep it here.
            </p>
            <Link to="/" className="btn btn-primary mx-auto mt-5 gap-2">
